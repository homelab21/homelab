...
import org.esp.homelab.security.SecurityUtils;
import org.esp.homelab.service.MailService;
import org.esp.homelab.service.UserService;
import org.esp.homelab.service.dto.PasswordChangeDTO;
import org.esp.homelab.service.dto.UserDTO;
import org.esp.homelab.web.rest.errors.*;
import org.esp.homelab.web.rest.vm.KeyAndPasswordVM;
import org.esp.homelab.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        User user = userService.registerUser(
            ...
            managedUserVM.getNumCNI(),
            managedUserVM.getPhone(),
            managedUserVM.getDateDeNaissance(),
            managedUserVM.getAddressLine1(),
            managedUserVM.getAddressLine2(),
            managedUserVM.getCity(),
            managedUserVM.getPays()
        );
